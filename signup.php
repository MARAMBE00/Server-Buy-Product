...
echo "<td style='border: 0px'><input type=password name=password maxlength=20 size=35></td></tr>";
echo "<tr><td style='border: 0px'>Confirm password:</td>";
echo "<td style='border: 0px'><input type=password name=compassword maxlength=20 size=35></td></tr>";
echo "<tr>";
